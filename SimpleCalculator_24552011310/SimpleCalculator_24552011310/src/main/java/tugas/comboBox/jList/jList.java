...
public class jList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nama dan Manakan Fav");
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        // TODO add your handling code here:
        nama = tfNama.getText();
        String isiList = jList1.getSelectedValue();
        
        if (isiList == "Nasi Goreng") {
            mknFav = "Nasi Goreng";
        } else if (isiList == "Sate Ayam") {
            mknFav = "Sate Ayam";
        } else if (isiList == "Semblak") {
            mknFav = "Semblak";
        } else if (isiList == "Soto Bandung") {
            mknFav = "Soto Bandung";
        } else if (isiList == "Siomay") {
            mknFav = "Siomay";
        } 
